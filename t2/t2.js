...
// HUOM ! lista <table> sisälle!

// 1.  haetaan kohteet mihin lisätää sisältö
...
// 2. sortataan ravintolat aakkosjärjestyksessä ennen taulukkoon laittamista
restaurants.sort((a, b) => a.name.localeCompare(b.name));

//  käydään taulukko läpi
// jokainen ravintola omalle riville
// luodaan taulukko sisimmältä ulos
for (const restaurant of restaurants) {
  if (restaurant) {
    // typequard - tsekkaa datan ehjyyden (kaikki ravintoloita eikä esim null välissä)

    // luodaan elementtipohjat datalle
    ...
    // lisätään kohteeseen nimi ja osoitee
    rivi.append(nimi, osoite); // riviin lisätään nimi ja osoite
    kohde.append(rivi); // kohteeseen lisätään kaikki rivit
  }
}
